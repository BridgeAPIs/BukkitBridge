...
public abstract class PlayerData {
	...
	public String getEffectiveName() {
		...
		return (eName == null) ? BukkitBridge.get().getUUIDTranslator().getName(playerID) : eName;
	}
	 ...
	 * @param key clé à récupérer
	 * @return valeur de la clé, null si elle n'existe pas
	 * @throws net.bridgesapi.api.player.InvalidTypeException si la valeur n'est pas du bon type
	 */
